...
class Authorization_Token 
{
     ...
     * Request Header Name
     */
    protected $token_header = ['authorization','Authorization','x-api-key','X-API-KEY','token','Token'];
    ...
    public function validateToken()
    {
         ...
         */
        $token_data = $this->tokenExists($headers);
     ...
     */
    public function validateTokenGet($token='')
    {
        if(!empty($token) AND is_string($token) AND !is_array($token))
        {
            try
     ...
     */
    public function tokenExists($headers)
    {
